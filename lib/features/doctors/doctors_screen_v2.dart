                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              compareMode
                                  ? '${row.appointmentCount} (${appointmentDelta >= 0 ? '+' : ''}$appointmentDelta) G求 ${row.patientCount} G求 Rs ${row.earned.toStringAsFixed(0)} (${earnedDelta >= 0 ? '+' : ''}${earnedDelta.toStringAsFixed(0)})'
                                  : '${row.appointmentCount} G求 ${row.patientCount} G求 Rs ${row.earned.toStringAsFixed(0)}',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text(
              'Appts G求 Completion G求 Revenue G求 Avg/Appt G求 Treatments',
              style: TextStyle(
                color: Color(0xFF5B789F),
                fontWeight: FontWeight.w700,
                fontSize: 12,
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(
                        width: 210,
                        child: Text(
                          '${(row.completionRate * 100).toStringAsFixed(0)}% G求 Avg Rs ${row.avgRevenue.toStringAsFixed(0)} G求 ${row.treatmentsCount} tx',
                          textAlign: TextAlign.right,
                          style: const TextStyle(
                            color: Color(0xFF5B789F),
                            fontWeight: FontWeight.w700,
